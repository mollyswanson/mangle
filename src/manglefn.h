...
#ifdef  GCC
int     balkanize(int npoly, polygon *[npoly], int npolys, polygon *[npolys], long double, format *, long double, long double, long double, long double);
#else
int     balkanize(int npoly, polygon *[/*npoly*/], int npolys, polygon *[/*npolys*/], long double, format *, long double, long double, long double, long double);
#endif
...
#ifdef  GCC
int     snap(int npoly, polygon *[npoly], long double, format *, long double, long double, long double, long double, int);
#else
int     snap(int npoly, polygon *[/*npoly*/], long double, format *, long double, long double, long double, long double, int);
#endif
...
#ifdef	GCC
int	fragment_poly(polygon **, polygon *, int, int npolys, polygon *[npolys], long double);
#else
int	fragment_poly(polygon **, polygon *, int, int npolys, polygon *[/*npolys*/], long double);
#endif
...
long double	twodf_(long double *, long double *);
