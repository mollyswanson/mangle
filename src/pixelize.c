...
/* getopt options */
//const char *optstr = "dqa:b:t:y:m:s:e:v:p:P:i:o:H";
...
{
  int ifile, nfiles, npoly, npolys, i, flag, res_max_temp;
  char scheme_temp;
  clock_t start, stop;
...
void usage(void)
{
 ...
 printf("pixelize [-d] [-q] [-m<a>[u]] [-s<n>] [-e<n>] [-vo|-vn] [-p[+|-][<n>]] [-P[scheme][<p>][,<r>]] [-i<f>[<n>][u]] [-o<f>[u]] [-H] polygon_infile1 [polygon_infile2 ...] polygon_outfile\n");
#include "usage.h"
}
