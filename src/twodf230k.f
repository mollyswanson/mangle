...
c-----------------------------------------------------------------------
      real*8 function twodf230k(ra,dec)
      real*8 ra,dec
c
c        parameters
      include 'pi.par'
...
c completeness: round to 8 decimal places
      twodf230k=dble(nint(twodf230k*1.d8))/1.d8
...
c     convert to x,y coordinate
      ...
      call bound_map2df2(NP,sgn,ix_min,iy_min)
...
c     It returns the ix_min and iy_min which are the offsets of the two maps.
      ...
      subroutine bound_map2df2(NP,sgn,ix_min,iy_min)
******************************************************************************
      implicit none
